      ...
      <Card className="w-full max-w-md container-peaceful border-0 shadow-peaceful">
        ...
        <div className="text-center mb-8">
          <div className="flex items-center justify-center mb-4">
            <div className="w-16 h-16 bg-gradient-sacred rounded-2xl flex items-center justify-center shadow-sacred">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <Button
            type="submit"
            className="w-full btn-sacred h-12 text-lg font-semibold"
            disabled={isLoading}
          >
            {isLoading ? (
